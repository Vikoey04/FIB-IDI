...
void MyGLWidget::creaBuffers ()
{
  ...
  // Actualitzem el uniform amb el valor inicial de scl
  // així aconseguim que al iniciar el programa es pinti el triangle abans de redimensionar amb les TECLES
